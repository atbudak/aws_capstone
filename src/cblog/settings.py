...
DATABASES = {
    'default': {
        ...
        'HOST': 'capstone-rds.c5wnhkyubboa.us-east-1.rds.amazonaws.com',  # database endpoint is written here
...
AWS_STORAGE_BUCKET_NAME = 'capstoneahmetblog' # please enter your s3 bucket name
